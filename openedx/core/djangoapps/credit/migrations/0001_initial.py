    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider_status_url', models.URLField(default=u'', help_text='URL from the credit provider where the user can check the status of their request for credit.  This is displayed to students *after* they have requested credit.')),
